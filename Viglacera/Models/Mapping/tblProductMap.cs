...
namespace Viglacera.Models.Mapping
{
    public class tblProductMap : EntityTypeConfiguration<tblProduct>
    {
        public tblProductMap()
        {
            ...
            this.Property(t => t.NameInvolve)
                .HasMaxLength(100);

            this.Property(t => t.CodeInvolve)
                .HasMaxLength(200);
            ...
            this.Property(t => t.NameInvolve).HasColumnName("NameInvolve");
            this.Property(t => t.CodeInvolve).HasColumnName("CodeInvolve");
